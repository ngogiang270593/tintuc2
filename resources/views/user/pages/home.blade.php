...
<div class="row">
  	<div class="col-lg-8 col-md-8 col-sm-8">
	    ...
	    @foreach($namtinmoi as $item)
	      	<div class="single_iteam"> <a href="{!! url('chi-tiet-tin',$item->id) !!}"> <img src="{!! url('upload/news',[$item->image]) !!}" alt=""></a>
      ...
      <div class="fashion_technology_area">
        <div class="fashion">
          <div class="single_post_content">
            ...
            <ul class="business_catgnav wow fadeInDown">
              <li>
                <figure class="bsbig_fig"> <a href="{!! url('chi-tiet-tin',$thethaomoinhat->id) !!}" class="featured_img"> <img alt="" src="{!! url('upload/news',[$thethaomoinhat->image]) !!}"> <span class="overlay"></span> </a>
            ...
            <ul class="spost_nav">
             @foreach($thethaomoitt as $item3)
              <li>
                <div class="media wow fadeInDown"> <a href="{!! url('chi-tiet-tin',$item3->id) !!}" class="media-left"> <img alt="" src="{!! url('upload/news',[$item3->image]) !!}"> </a>
        ...
        <div class="technology">
          <div class="single_post_content">
            ...
            <ul class="business_catgnav wow fadeInDown">
              <li>
                <figure class="bsbig_fig"> <a href="{!! url('chi-tiet-tin',$giaitrimoinhat->id) !!}" class="featured_img"> <img alt="" src="{!! url('upload/news',[$giaitrimoinhat->image]) !!}"> <span class="overlay"></span> </a>
           ...
           <ul class="spost_nav">
             @foreach($giaitrimoitt as $item4)
              <li>
                <div class="media wow fadeInDown"> <a href="{!! url('chi-tiet-tin',$item4->id) !!}" class="media-left"> <img alt="" src="{!! url('upload/news',[$item4->image]) !!}"> </a>
    ...
    <aside class="right_content">
      <div class="single_sidebar">
        ...
        @foreach($tinhot as $item2)
          <li>
            <div class="media wow fadeInDown"> <a href="{!! url('chi-tiet-tin',$item2->id) !!}" class="media-left"> <img alt="" src="{!! url('upload/news',[$item2->image]) !!}"> </a>
