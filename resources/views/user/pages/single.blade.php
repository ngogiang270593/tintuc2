    ...
    <aside class="right_content">
      <div class="single_sidebar">
        ...
        <ul class="spost_nav">
         ...
         <li>
            <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt="" src="{!! url('upload/news',[$item1->image]) !!}"> </a>
      ...
      <div class="single_sidebar">
        ...
        <ul class="spost_nav">
         ...
         <li>
            <div class="media wow fadeInDown"> <a href="single_page.html" class="media-left"> <img alt="" src="{!! url('upload/news',[$item2->image]) !!}"> </a>
              <div class="media-body">
