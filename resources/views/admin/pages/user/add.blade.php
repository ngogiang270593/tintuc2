    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
            <br />
            <form action="{!! url('admin/user/add') !!}" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" name="txtUserName" required="required" class="form-control col-md-7 col-xs-12" value="{!! old('txtUserName') !!}">
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="col-md-6 col-sm-6 col-xs-12">
                 <input name="txtEmail" class="form-control col-md-7 col-xs-12" required="required" type="email" value="{!! old('txtEmail') !!}">
               </div>
              </div>
              <div class="form-group">
